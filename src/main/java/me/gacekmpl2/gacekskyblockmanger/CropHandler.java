...
public class CropHandler {
    ...
    static {
        ...
        cropToPermissionMap.put(Material.WHEAT, "skyblockmanager.replant.wheat");
        cropToPermissionMap.put(Material.POTATOES, "skyblockmanager.replant.potato");
        cropToPermissionMap.put(Material.CARROTS, "skyblockmanagert.replant.carrot");
        cropToPermissionMap.put(Material.BEETROOTS, "skyblockmanager.replant.beetroot");
    }
