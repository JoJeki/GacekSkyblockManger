...
public class ItemCreator {
    ...
    /**
     * Create a new ItemCreator from scratch.
     * @param m The material to create the ItemCreator with.
     */
    public ItemCreator(Material m){
        this(m, 1);
    }
    /**
     * Create a new ItemCreator over an existing itemstack.
     * @param is The itemstack to create the ItemCreator over.
     */
    ...
    /**
     * Clone the ItemCreator into a new one.
    ...
    /**
     * Retrieves the itemstack from the ItemCreator.
     * @return The itemstack created/modified by the ItemCreator instance.
     */
